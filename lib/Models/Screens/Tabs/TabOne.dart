...
class _TabOneState extends State<TabOne> {
  ...
  Future<void> addToFavourite(Plant plant) async {
              ...
              itemBuilder: (BuildContext context, int index) {
                favourites.forEach((element) {
                  if (__plantList[index].plantId == element.plantId) {
                    __plantList[index].isFavorated = element.isFavorated;
                  }
                });
                      ...
                      children: [
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: IconButton(
                              onPressed: () async {
                                bool isFavorited = !__plantList[index].isFavorated;
                                setState(() {
                                  __plantList[index].isFavorated = isFavorited;
                                });
