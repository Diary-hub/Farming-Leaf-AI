...
class DetailPageAll extends StatefulWidget {
  final int plantId;
  final List<Plant> lits;
  const DetailPageAll({Key? key, required this.plantId, required this.lits}) : super(key: key);

  @override
  State<DetailPageAll> createState() => _DetailPageAllState();
}
...
class _DetailPageAllState extends State<DetailPageAll> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Plant> __plantList = widget.lits;
    return Scaffold(
      body: Stack(
        children: [
          Positioned(
